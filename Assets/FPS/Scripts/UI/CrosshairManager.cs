...
namespace Unity.FPS.UI
{
    public class CrosshairManager : MonoBehaviour
    {
        ...
        void Start()
        {
            m_WeaponsManager = GameObject.FindObjectOfType<PlayerWeaponsManagerN>();
            DebugUtility.HandleErrorIfNullFindObject<PlayerWeaponsManagerN, CrosshairManager>(m_WeaponsManager, this);
