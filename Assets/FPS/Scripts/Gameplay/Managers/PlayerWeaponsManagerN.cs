...
namespace Unity.FPS.Gameplay
{
    ...
    public class PlayerWeaponsManagerN : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            DebugUtility.HandleErrorIfNullGetComponent<PlayerCharacterControllerN, PlayerWeaponsManagerN>(
                m_PlayerCharacterControllerN, this, gameObject);
        ...
        void LateUpdate()
        {
            ...
            if(m_PlayerCharacterControllerN.IsDead == false)
            {
        ...
        {
            m_PlayerCharacterControllerN.PlayerCamera.fieldOfView = fov;
        ...
        void UpdateWeaponAiming()
        {
            if (m_WeaponSwitchState == WeaponSwitchState.Up)
            {
                ...
                if (IsAiming && activeWeapon)
                {
                    ...
                    SetFov(Mathf.Lerp(m_PlayerCharacterControllerN.PlayerCamera.fieldOfView,
                ...
                else
                {
                    ...
                    SetFov(Mathf.Lerp(m_PlayerCharacterControllerN.PlayerCamera.fieldOfView, DefaultFov,
                        AimingAnimationSpeed * Time.deltaTime));
                }
            }
        }
        ...
        void UpdateWeaponBob()
        {
            if (Time.deltaTime > 0f)
            {
                Vector3 playerCharacterVelocity =
                    (m_PlayerCharacterControllerN.transform.position - m_LastCharacterPosition) / Time.deltaTime;

                // calculate a smoothed weapon bob amount based on how close to our max grounded movement velocity we are
                float characterMovementFactor = 0f;
                if (m_PlayerCharacterControllerN.IsGrounded)
                {
                    characterMovementFactor =
                        Mathf.Clamp01(playerCharacterVelocity.magnitude /
                                      (m_PlayerCharacterControllerN.MaxSpeedOnGround *
                                       m_PlayerCharacterControllerN.SprintSpeedModifier));
                }
                ...
                m_LastCharacterPosition = m_PlayerCharacterControllerN.transform.position;
            }
        }
