...
namespace Unity.FPS.Gameplay
{
    ...
    public class PlayerCharacterControllerN : NetworkBehaviour
    {
        ...
        void Start()
        {
            ...
            DebugUtility.HandleErrorIfNullGetComponent<PlayerWeaponsManagerN, PlayerCharacterControllerN>(
                m_WeaponsManager, this, gameObject);

            m_Health = GetComponent<Health>();
            DebugUtility.HandleErrorIfNullGetComponent<Health, PlayerCharacterControllerN>(m_Health, this, gameObject);

            m_Actor = GetComponent<Actor>();
            DebugUtility.HandleErrorIfNullGetComponent<Actor, PlayerCharacterControllerN>(m_Actor, this, gameObject);
