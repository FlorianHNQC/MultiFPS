...
{
    public class PlayerInputN : NetworkBehaviour
    {
        ...
        void Start()
        {
            ...
            DebugUtility.HandleErrorIfNullGetComponent<PlayerCharacterControllerN, PlayerInputN>(
                m_PlayerCharacterControllerN, this, gameObject);
            m_GameFlowManager = FindObjectOfType<GameFlowManager>();
            DebugUtility.HandleErrorIfNullFindObject<GameFlowManager, PlayerInputN>(m_GameFlowManager, this);
...
/*        private void Update()
        {
            ...
            if (Input.GetKey(KeyCode.Q)) moveDir.z = +1f;
